...
public class TxManager
{
     ...
     * @throws com.ibbl.tx.TxException
     */
        ...
        try
        {
            synchronized (_SYNC_)
            {
                if (sf == null)
                {
                    ...
                    configuration.configure("com/ibbl/config/hibernate.cfg.xml");
     ...
     * Open a new Session
     *
     * @throws com.ibbl.tx.TxException .If already session already opened, exception is thrown
     */
